...
export const botSchema = z.object({
  ...
  failureConfirmationCount: z.number().int().min(1).max(10).default(2),
  reminderIntervalMinutes: z.number().int().min(0).max(10080).default(0),
  expectedContent: z.string().max(500).nullable().optional(),
